...
MIXPANEL_EVENT_INIT <- "LCA open"
MIXPANEL_EVENT_CODE <- "LCA inserted code"
MIXPANEL_EVENT_INTERACTION <- "LCA interaction"
MIXPANEL_SECTION_LOAD <- "load_data"
MIXPANEL_SECTION_XFORM <- "transformations"
MIXPANEL_SECTION_VIZ <- "visualizations"
MIXPANEL_SECTION_SNIPPETS <- "snippets"
